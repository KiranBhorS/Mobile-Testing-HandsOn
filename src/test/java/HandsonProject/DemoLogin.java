...

{
	public static void main (String[] args) throws MalformedURLException, InterruptedException
	{
		...
		driver.findElement(By.id("Email")).sendKeys("bhorkiran1118@gmail.com");
		driver.findElement(By.id("Password")).sendKeys("Adavika@123");
       ...
       // driver.findElement(By.xpath("/*[@value='Add to cart']")).click();
        ...
        Thread.sleep(6000);
         ...
         Thread.sleep(5000);
         driver.findElement(By.id("ZipPostalCode")).sendKeys("414111");
